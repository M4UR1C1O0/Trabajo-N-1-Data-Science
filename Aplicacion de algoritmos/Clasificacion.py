...
# =============================================================================
# Estandarizacion de variables (mejor desempeño del modelo)
...
# =============================================================================
# Obtener predicciones del modelo para los datos reales
x_real = X_scaled[:, 1]                   # Lesionados - Graves 
...
# =============================================================================
# Calcular y graficar la curva logistica suavizada
...
X_curve_full = np.column_stack([
    ...
    np.full_like(X_curve, X_scaled[:, 4].mean()),   # Poblacipn
    np.full_like(X_curve, X_scaled[:, 5].mean()),   # Tasa motorizacion
])
y_curve = model.predict_proba(X_curve_full)[:, 1]

# =============================================================================
# Visualizacion profesional del grafico
plt.figure(figsize=(12, 8))

# Curva logistica del modelo
plt.plot(X_curve, y_curve, color='black', lw=2, label='Curva logistica (modelo)')

# Puntos clasificados como "Alta mortalidad" (por el modelo)
...
# Puntos clasificados como "Baja mortalidad" (por el modelo)
